...
if [[ "${SLUG}" == "profit" ]]; then
  write_redirect "profit_optimization.html" "${FINGERPRINT}"
fi

echo "PUBLISHED docs/${FINGERPRINT}"
echo "STABLE   https://arpasan.github.io/legacy_r_stuff/${SLUG}.html"
echo "DIRECT   https://arpasan.github.io/legacy_r_stuff/${FINGERPRINT}"
